...
checkLoggedIn = function() {
	...
	if ($j.cookie || $j('body').hasClass('log_pre') || $j('body').hasClass('log_post')) {
		...
		if($j.cookie){
			  if ($j.cookie('u_cst_info')) {
				...
				var plan_cos = customer_info_array[0]; //should be like COS211
					if(plan_cos == 'COS211'){
						chage_plan_link = '<li><a class="my_account_overlay" href="https://www1.virginmobileusa.com/myaccount/prepareAWBolton.do">// Change My Offer</a></li>';
					}
					else{
						chage_plan_link = '<li><a class="my_account_overlay" href="https://www1.virginmobileusa.com/myaccount/migrationOverview.do">// Change My Plan</a></li>';
					}
			  }
		}
		...
		if (isMyAccountMain) {
			...
			sign_in_overlay_html = '<li><p>My Shortcuts</p><div class="clearfix"><ul class="left"><li><a href="https://www1.virginmobileusa.com/myaccount/home.do">// My Account Home</a></li><li><a href="https://www1.virginmobileusa.com/myaccount/topup.do">// Top-Up </a></li><li><a class="my_account_overlay" href="https://www1.virginmobileusa.com/myaccount/accountHistory.do">// Account Activity</a></li><li><a class="my_account_overlay" href="https://www1.virginmobileusa.com/myaccount/paymentHistory.do">// Payment History</a></li></ul><ul class="right">' + chage_plan_link + '<li><a href="http://www.virginmobileusa.com/help-support">// Get Support</a></li><li><a href="http://www.virginmobileusa.com/cell-phone-plans/beyond-talk-plans.jsp">// Learn About My Plan</a></li><li><a href="http://www.virginmobileusa.com/cell-phone-plans/beyond-talk-plans.jsp">// Learn About My Phone</a></li></ul></div></li>';
		}
		else {
			sign_in_overlay_html = '<li><p>My Shortcuts</p><div class="clearfix"><ul class="left"><li><a href="https://www1.virginmobileusa.com/myaccount/home.do">// My Account Home</a></li><li><a href="https://www1.virginmobileusa.com/myaccount/topup.do">// Top-Up </a></li><li><a href="https://www1.virginmobileusa.com/myaccount/accountHistory.do">// Account Activity</a></li><li><a href="https://www1.virginmobileusa.com/myaccount/paymentHistory.do">// Payment History</a></li></ul><ul class="right">' + chage_plan_link + '<li><a href="http://www.virginmobileusa.com/help-support">// Get Support</a></li><li><a href="http://www.virginmobileusa.com/cell-phone-plans/beyond-talk-plans.jsp">// Learn About My Plan</a></li><li><a href="http://www.virginmobileusa.com/cell-phone-plans/beyond-talk-plans.jsp">// Learn About My Phone</a></li></ul></div></li>';
		}
		...
		if ($j('body').hasClass('log_pre')) {
			...
			// add logout link
			$j('#nav_main4_4').find('a').attr("href", "https://www1.virginmobileusa.com/login/logout.do");
